namespace HumanitarianProjectManagement.Forms
{
    partial class ProjectCreateEditForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            // Placeholder for a button that might lead to adding activities related to an output of this outcome
            // For now, just naming it to indicate it's a placeholder for activity related actions from outcome level
            this.btnAddActivityViaOutcome1_placeholder = new System.Windows.Forms.Button();


            this.tabPageDetailedBudget = new System.Windows.Forms.TabPage();
            this.flpBudgetCategories = new System.Windows.Forms.FlowLayoutPanel();
            ...
            this.pnlButtons = new System.Windows.Forms.Panel(); // Panel for Save/Cancel buttons
            ...
            this.tabPageDetailedBudget.SuspendLayout();
            ...
            this.tabControlProjectDetails.Controls.Add(this.tabPageDetailedBudget);
            ...
            this.tabControlProjectDetails.Size = new System.Drawing.Size(434, 451); // Adjusted size, buttons will be below
            ...
            this.tabPageGeneralInfo.Size = new System.Drawing.Size(426, 425); // Adjusted size
            ...
            //
            // lblProjectName to cmbManager setup (Copied from existing, adjust locations/TabIndex as needed)
            // Values are illustrative for placement; precise layout would be done in a visual designer.
            // 
            ...
            // Start Date, End Date, Location, Objective, Status, Donor, TotalBudget, Section, Manager...
            // These would follow a similar pattern, adjusting Point(X,Y) and TabIndex
            int currentY = 75;
            int labelX = 15;
            int controlX = 120;
            int tabIdx = 3;
            ...
            this.pnlLogFrameMain.Controls.Add(this.pnlOutcome1); // Add placeholder outcome panel
            ...
            //this.btnAddOutcome.Click += new System.EventHandler(this.btnAddOutcome_Click); // To be wired in .cs
            //
            // pnlOutcome1 (Placeholder for first outcome)
            //
            this.pnlOutcome1.AutoSize = true;
            this.pnlOutcome1.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
            this.pnlOutputsContainer = new System.Windows.Forms.Panel(); // New panel for outputs
            this.pnlOutcome1.Controls.Add(this.pnlOutputsContainer); // Add it below description
            ...
            this.pnlOutcome1.Location = new System.Drawing.Point(0, 23); // Below btnAddOutcome
            this.pnlOutcome1.Padding = new System.Windows.Forms.Padding(5);
            this.pnlOutcome1.Name = "pnlOutcome1";
            this.pnlOutcome1.Size = new System.Drawing.Size(420, 100); // Example size
            ...
            this.txtOutcome1Description.Size = new System.Drawing.Size(408, 40); // Adjusted width
            ...
            this.pnlOutputsContainer.Location = new System.Drawing.Point(5, 70); // Below description
            this.pnlOutputsContainer.Name = "pnlOutputsContainer";
            this.pnlOutputsContainer.Size = new System.Drawing.Size(408, 0); // Height will be set by AutoSize or dynamically
            this.pnlOutputsContainer.AutoSize = true; // Allow it to grow
            this.pnlOutputsContainer.MinimumSize = new System.Drawing.Size(0, 50); // Minimum height for visibility
            ...
            this.btnAddOutputToOutcome1.Location = new System.Drawing.Point(5, 65); // Positioned relative to pnlOutcome1's bottom logic
            ...
            //
            // tabPageDetailedBudget
            //
            this.tabPageDetailedBudget.Controls.Add(this.flpBudgetCategories);
            this.tabPageDetailedBudget.Location = new System.Drawing.Point(4, 22);
            this.tabPageDetailedBudget.Name = "tabPageDetailedBudget";
            this.tabPageDetailedBudget.Padding = new System.Windows.Forms.Padding(3);
            this.tabPageDetailedBudget.Size = new System.Drawing.Size(426, 425);
            this.tabPageDetailedBudget.TabIndex = 2;
            this.tabPageDetailedBudget.Text = "Detailed Budget";
            this.tabPageDetailedBudget.UseVisualStyleBackColor = true;
            //
            // flpBudgetCategories
            //
            this.flpBudgetCategories.AutoScroll = true;
            this.flpBudgetCategories.Dock = System.Windows.Forms.DockStyle.Fill;
            this.flpBudgetCategories.FlowDirection = System.Windows.Forms.FlowDirection.TopDown;
            this.flpBudgetCategories.Location = new System.Drawing.Point(3, 3);
            this.flpBudgetCategories.Name = "flpBudgetCategories";
            this.flpBudgetCategories.Size = new System.Drawing.Size(420, 419);
            this.flpBudgetCategories.TabIndex = 0;
            this.flpBudgetCategories.WrapContents = false;
            //
            // tabPageActivityPlan
            //
            ...
            this.tabPageActivityPlan.TabIndex = 3;
            ...
            this.pnlButtons.Size = new System.Drawing.Size(434, 40); // Form height 491 - TabControl height 451 = 40
            this.pnlButtons.TabIndex = 1;
            // 
            // btnSave
            // 
            this.btnSave.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
            this.btnSave.Location = new System.Drawing.Point(228, 8); // Example location
            this.btnSave.Name = "btnSave";
            this.btnSave.Size = new System.Drawing.Size(95, 23);
            this.btnSave.TabIndex = 0; // TabIndex within this panel
            ...
            this.btnCancel.Location = new System.Drawing.Point(329, 8); // Example location
            this.btnCancel.Name = "btnCancel";
            this.btnCancel.Size = new System.Drawing.Size(95, 23);
            this.btnCancel.TabIndex = 1; // TabIndex within this panel
            ...
            this.ClientSize = new System.Drawing.Size(434, 491); // Original ClientSize
            this.Controls.Add(this.tabControlProjectDetails); // TabControl fills most space
            this.Controls.Add(this.pnlButtons); // Button panel at the bottom
            this.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedDialog;
            this.MaximizeBox = false;
            this.MinimizeBox = false;
            this.Name = "ProjectCreateEditForm";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
            this.Text = "Project Details"; // Will be updated by .cs code for Add/Edit
            ...
            this.pnlLogFrameMain.PerformLayout(); // For AutoScroll if content exceeds bounds
            this.pnlOutcome1.ResumeLayout(false);
            this.pnlOutcome1.PerformLayout();
            this.tabPageDetailedBudget.ResumeLayout(false);
            // flpBudgetCategories does not need PerformLayout if it's just a container
            ...
            // PerformLayout removed as it's usually not needed after explicit Suspend/Resume.
        }
        ...
        // TabPage GeneralInfo and its controls
        ...
        // TabPage LogicalFramework and its controls
        ...
        private System.Windows.Forms.Panel pnlOutcome1; // Placeholder for first outcome UI
        private System.Windows.Forms.Label lblOutcome1;
        private System.Windows.Forms.TextBox txtOutcome1Description;
        private System.Windows.Forms.Panel pnlOutputsContainer; // Added declaration
        ...
        // TabPage DetailedBudget and its controls
        private System.Windows.Forms.TabPage tabPageDetailedBudget;
        private System.Windows.Forms.FlowLayoutPanel flpBudgetCategories;

        // TabPage ActivityPlan and its controls
        private System.Windows.Forms.TabPage tabPageActivityPlan;
        private System.Windows.Forms.DataGridView dgvActivityPlan;

        // Buttons (now potentially in a separate panel)
